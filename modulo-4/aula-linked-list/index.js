...
// testando isEmpty numa lista vazia
// retorna true
console.log(listaLinkada.isEmpty());
...
// returns 1
console.log("Tamanho da lista: ", listaLinkada.getSize());
...
console.log("o elemento foi removido ? " + listaLinkada.removeElement(50));
  
// prints 10 20 30 40
listaLinkada.printList();
  
// returns 3
console.log("Index do elemento 40: " + listaLinkada.indexOf(40));
  
// insert 60 at second position
// listaLinkada contains 10 20 60 30 40
listaLinkada.insertAt(60, 2);
  
listaLinkada.printList();
  
// returns false
console.log("A lista está vazia?? " + listaLinkada.isEmpty());
  
// remove o 3º elemento da lista
console.log(listaLinkada.removeFrom(3));
  
// prints 10 20 60 40
listaLinkada.printList();

// Agora, vamos testar o método getFirst
let primeiroElemento = listaLinkada.getFirst();
console.log("Primeiro elemento:", primeiroElemento ? primeiroElemento.data : 'Lista vazia');

// E também o método getLast
let ultimoElemento = listaLinkada.getLast();
console.log("Último elemento:", ultimoElemento ? ultimoElemento.data : 'Lista vazia');
...
// mostrar que realmente a lista está vazia
listaLinkada.printList();
